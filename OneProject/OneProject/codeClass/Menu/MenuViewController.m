...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:{
            ...
            [menuController setRootController:navigation animated:YES];
        }
            break;
        case 1: {
            RadioViewController *redioVC = [[RadioViewController alloc]init];
            UINavigationController *navigtion = [[UINavigationController alloc]initWithRootViewController:redioVC];
            [menuController setRootController:navigtion animated:YES];
        }
            break;
        case 2: {
            TopicViewController *topicVC = [[TopicViewController alloc]init];
            UINavigationController *navigtion = [[UINavigationController alloc]initWithRootViewController:topicVC];
            [menuController setRootController:navigtion animated:YES];
        ...
        case 3: {
            ...
            UINavigationController *navigtion = [[UINavigationController alloc]initWithRootViewController:goodVC];
            [menuController setRootController:navigtion animated:YES];
